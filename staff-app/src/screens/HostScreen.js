...
export default function HostScreen({ api, staffName, onBack }) {
  ...
  const resetForm = () => {
    ...
    setToDate(''); setFromTime(''); setToTime('');
          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.formRow}>
              <View style={styles.inputHalf}>
                ...
                <TextInput style={styles.input} value={fromDate} onChangeText={setFromDate} placeholder="2025-01-15" />
              </View>
              <View style={styles.inputHalf}>
                <Text style={styles.label}>To Date (optional)</Text>
                <TextInput style={styles.input} value={toDate} onChangeText={setToDate} placeholder="2025-01-16" />
              </View>
            </View>
            ...
            <View style={styles.formRow}>
              ...
              <View style={styles.inputHalf}>
                <Text style={styles.label}>To Time (optional)</Text>
                <TextInput style={styles.input} value={toTime} onChangeText={setToTime} placeholder="22:00" />
              </View>
            </View>

            {/* Multi-Section Selection */}
            <Text style={styles.label}>Sections (tap to select)</Text>
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16, backgroundColor: '#7C3AED' },
  backBtn: { padding: 8 },
  backBtnText: { color: '#FFF', fontSize: 14, fontWeight: '600' },
  title: { color: '#FFF', fontSize: 18, fontWeight: '700' },
  addBtn: { backgroundColor: '#FFF', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6 },
  addBtnText: { color: '#7C3AED', fontWeight: '700', fontSize: 13 },
  content: { padding: 16, paddingBottom: 40 },
  formCard: { backgroundColor: '#FFF', borderRadius: 12, padding: 16, marginBottom: 20, elevation: 2 },
  ...
  input: { backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 8, padding: 10, fontSize: 14, color: '#1F2937' },
  chipRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 10 },
  chip: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, borderWidth: 1, borderColor: '#D1D5DB', backgroundColor: '#F9FAFB' },
  chipActive: { backgroundColor: '#7C3AED', borderColor: '#7C3AED' },
  chipText: { fontSize: 12, fontWeight: '600', color: '#6B7280' },
  chipTextActive: { color: '#FFF' },
  mutedText: { fontSize: 12, color: '#9CA3AF', fontStyle: 'italic' },
  submitBtn: { backgroundColor: '#7C3AED', padding: 14, borderRadius: 8, alignItems: 'center', marginTop: 12 },
  submitBtnText: { color: '#FFF', fontSize: 15, fontWeight: '700' },
  sectionTitle: { fontSize: 16, fontWeight: '700', color: '#1F2937', marginBottom: 12 },
  emptyState: { alignItems: 'center', padding: 40 },
  emptyText: { color: '#9CA3AF', fontSize: 14 },
  bookingCard: { backgroundColor: '#FFF', borderRadius: 10, padding: 14, marginBottom: 12, borderLeftWidth: 4, borderLeftColor: '#7C3AED', elevation: 1 },
